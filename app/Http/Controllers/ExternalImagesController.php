...
class ExternalImagesController extends Controller {
    ...
    public function cropImage(ImageProcessor $image, $percentCrop)
    {
        ...
        $percent_section = json_decode($percentCrop);
        $section = [
            'x' => (int) ($image_width * $percent_section->x / 100),
            'y' => (int) ($image_height * $percent_section->y / 100),
            'width' => (int) ($image_width * $percent_section->width / 100),
            'height' => (int) ($image_height * $percent_section->height / 100),
        ];
