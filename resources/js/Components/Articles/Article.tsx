...
import {IArticle, IArticlesContext} from "@/Store/ArticleStore/types/Article";
...
const Article = ({article, handleEditorDialog, handleNewArticleDialog, loading}: IArticleProps) => {
    ...
    return (
        <Card>
            <ArticleHeader type={article.type} addArticle={handleNewArticleDialog.bind(null, article.id)}
                           title={article.title}/>
